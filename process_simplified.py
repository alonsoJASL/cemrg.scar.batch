...
CEMRG = {
    'win32': r'C:/dev/build/CEMRG/MITK-build/bin', 
    'linux': r'/home/jsl19/dev/build/CEMRG2-U20/MITK-build/bin',
    'darwin': r'~/dev/build/CEMRG/MITK-build/bin'
}
...
MIRTK = {
    'win32' : r'C:/Lib/cemrg_libraries/MLib', # check this one
...
if __name__ == '__main__':
    ...
    pp = args.patient if args.patient else ''
    LOGFILE = os.path.join(args.base_dir, pp, f'{args.mode}-{DATE}.log')
